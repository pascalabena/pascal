...
let ListPostViewComponent = class ListPostViewComponent {
    constructor(postService) {
        this.postService = postService;
    }
    ngOnInit() {
...
ListPostViewComponent.ctorParameters = () => [
    { type: _services_post_service__WEBPACK_IMPORTED_MODULE_2__["PostService"] }
];
...
let MenuNavigationComponent = class MenuNavigationComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PostService = class PostService {
    ...
    addPost(id, title, content, loveIts, numberLoveIt, numberdontLoveIt, created_at) {
        const postObject = {
            id: 0,
            title: '',
            content: '',
    ...
    updateDownLoveIts(id) {
        this.getPostById(+id).loveIts = this.getPostById(+id).loveIts - 1;
        console.log(" >>> Love It Service : " + this.getPostById(+id).loveIts);
        this.emitPostsSubject();
    }
    updateUpNumberLoveIts(id) {
